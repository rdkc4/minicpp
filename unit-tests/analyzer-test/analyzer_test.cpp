...
TEST_F(FunctionAnalyzerFixture, CheckFunction){
    ...
    scopeManager.pushSymbol(semantic::Symbol{"fun", semantic::Kind::FUN, Type::INT});
    initAnalyzer();
...
TEST_F(FunctionAnalyzerFixture, CheckFunctionVoidReturnsTypeError){
    ...
    scopeManager.pushSymbol(semantic::Symbol{"fun", semantic::Kind::FUN, Type::VOID});
    initAnalyzer();
...
TEST_F(StatementAnalyzerFixture, CheckVariableRedefError){
    input = {"int x = 5;"};
    scopeManager.pushSymbol(semantic::Symbol{"x", semantic::Kind::VAR, Type::INT});
    initAnalyzer();
...
TEST_F(StatementAnalyzerFixture, ForStatement){
    ...
    scopeManager.pushSymbol(semantic::Symbol{"i", semantic::Kind::VAR, Type::INT});
    initAnalyzer();
