...
TEST_F(FunctionAnalyzerFixture, CheckFunction){
    ...
    scopeManager.pushSymbol(sym::Symbol{"fun", Kind::FUN, Type::INT});
    initAnalyzer();
...
TEST_F(FunctionAnalyzerFixture, CheckFunctionVoidReturnsTypeError){
    ...
    scopeManager.pushSymbol(sym::Symbol{"fun", Kind::FUN, Type::VOID});
    initAnalyzer();
...
TEST_F(StatementAnalyzerFixture, CheckVariableRedefError){
    input = {"int x = 5;"};
    scopeManager.pushSymbol(sym::Symbol{"x", Kind::VAR, Type::INT});
    initAnalyzer();
...
TEST_F(StatementAnalyzerFixture, ForStatement){
    ...
    scopeManager.pushSymbol(sym::Symbol{"i", Kind::VAR, Type::INT});
    initAnalyzer();
