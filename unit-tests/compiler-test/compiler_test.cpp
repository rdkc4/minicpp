...
TEST(CompilerTest, NoErr){
    std::string path{"o.s"};
    Compiler::ExitCode ret{ Compiler::compile("int main(){ return 0; }", path) };
...
TEST(CompilerTest, NoErrScope){
    std::string path{"o.s"};
    Compiler::ExitCode ret{ Compiler::compile("int main(){ {int a;} int a; return 0; }", path) };
...
TEST(CompilerTest, LexicalErr){
    std::string path{ "o.s"};
    Compiler::ExitCode ret{ Compiler::compile("int mai$n(){ return 0; }", path) };
...
TEST(CompilerTest, SyntaxErr){
    std::string path{ "o.s" };    
    Compiler::ExitCode ret{ Compiler::compile("main(){ return 0; }", path) };
...
TEST(CompilerTest, SemanticErrTypeMismatch){
    std::string path{ "o.s" };
    Compiler::ExitCode ret{ Compiler::compile("int main(){ return 5 + 3u; }", path) };
...
TEST(CompilerTest, SemanticErrUndefVariable){
    std::string path{ "o.s" };
    Compiler::ExitCode ret{ Compiler::compile("int main(){ return a; }", path) };
...
TEST(CompilerTest, IRErr){
    std::string path{ "o.s" };
    Compiler::ExitCode ret{ Compiler::compile("int main(){ return 3/0; }", path) };
...
TEST(CompilerTest, CodeGenErr){
    ...
    ASSERT_EQ(ret, Compiler::ExitCode::CODEGEN_ERR);
}