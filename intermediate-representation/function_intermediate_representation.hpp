...
namespace IR {
    ...
    */
    ...
    public:
        ...
        */
        std::unique_ptr<node::IRFunction> transformFunction(const ASTFunction* astFunction);
         ...
         * @param astFunction - const pointer to the ast function
        */
        void transformParameters(IR::node::IRFunction* irFunction, const ASTFunction* astFunction);
         ...
         * @param astFunction - const pointer to the ast function
        */
        void transformBody(IR::node::IRFunction* irFunction, const ASTFunction* astFunction);
