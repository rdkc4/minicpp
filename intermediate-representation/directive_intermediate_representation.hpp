...
namespace IR {
    ...
    */
    ...
    public:
        ...
        */
        void transformDir(IR::node::IRProgram* irProgram, const syntax::ast::ASTProgram* astProgram);
        ...
        */
        void transformIncludeDir(IR::node::IRProgram* irProgram, const syntax::ast::ASTIncludeDir* astLib);
    };
