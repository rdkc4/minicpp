...
namespace IR {
    ...
    */
    ...
    public:
        ...
        */
        std::unique_ptr<node::IRVariableDeclStmt> transformVariableDeclStmt(const AST::node::ASTVariableDeclStmt* astVariableDecl);
        ...
        */
        std::unique_ptr<node::IRIfStmt> transformIfStmt(const AST::node::ASTIfStmt* astIfStmt);
        ...
        */
        std::unique_ptr<node::IRCompoundStmt> transformCompoundStmt(const AST::node::ASTCompoundStmt* astCompoundStmt);
         ...
         * @returns pointer to the irt statement
        */
        std::unique_ptr<node::IRAssignStmt> transformAssignStmt(const AST::node::ASTAssignStmt* astAssignStmt);
        ...
        */
        std::unique_ptr<node::IRReturnStmt> transformReturnStmt(const AST::node::ASTReturnStmt* astReturnStmt);
        ...
        */
        std::unique_ptr<node::IRFunctionCallStmt> transformFunctionCallStmt(const AST::node::ASTFunctionCallStmt* astCallStmt);
        ...
        */
        std::unique_ptr<node::IRWhileStmt> transformWhileStmt(const AST::node::ASTWhileStmt* astWhileStmt);
        ...
        */
        std::unique_ptr<node::IRForStmt> transformForStmt(const AST::node::ASTForStmt* astForStmt);
        ...
        */
        std::unique_ptr<node::IRDoWhileStmt> transformDoWhileStmt(const AST::node::ASTDoWhileStmt* astDowhileStmt);
        ...
        */
        std::unique_ptr<node::IRSwitchStmt> transformSwitchStmt(const AST::node::ASTSwitchStmt* astSwitchStmt);
        ...
        */
        std::unique_ptr<node::IRCaseStmt> transformCaseStmt(const AST::node::ASTCaseStmt* astCaseStmt);
        ...
        */
        std::unique_ptr<node::IRDefaultStmt> transformDefaultStmt(const AST::node::ASTDefaultStmt* astDefaultStmt);
        ...
        */
        std::unique_ptr<node::IRSwitchBlockStmt> transformSwitchBlockStmt(const AST::node::ASTSwitchBlockStmt* astSwitchBlockStmt);
