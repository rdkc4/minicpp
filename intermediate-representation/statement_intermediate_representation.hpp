...
namespace IR {
    ...
    */
    ...
    public:
        ...
        */
        std::unique_ptr<node::IRStmt> transformStmt(const ASTStmt* astStmt);
        ...
        */
        std::unique_ptr<node::IRVariableDeclStmt> transformVariableDeclStmt(const ASTVariableDeclStmt* astVariableDecl);
        ...
        */
        std::unique_ptr<node::IRIfStmt> transformIfStmt(const ASTIfStmt* astIfStmt);
        ...
        */
        std::unique_ptr<node::IRCompoundStmt> transformCompoundStmt(const ASTCompoundStmt* astCompoundStmt);
         ...
         * @returns pointer to the irt statement
        */
        std::unique_ptr<node::IRAssignStmt> transformAssignStmt(const ASTAssignStmt* astAssignStmt);
        ...
        */
        std::unique_ptr<node::IRReturnStmt> transformReturnStmt(const ASTReturnStmt* astReturnStmt);
        ...
        */
        std::unique_ptr<node::IRFunctionCallStmt> transformFunctionCallStmt(const ASTFunctionCallStmt* astCallStmt);
        ...
        */
        std::unique_ptr<node::IRWhileStmt> transformWhileStmt(const ASTWhileStmt* astWhileStmt);
        ...
        */
        std::unique_ptr<node::IRForStmt> transformForStmt(const ASTForStmt* astForStmt);
        ...
        */
        std::unique_ptr<node::IRDoWhileStmt> transformDoWhileStmt(const ASTDoWhileStmt* astDowhileStmt);
        ...
        */
        std::unique_ptr<node::IRSwitchStmt> transformSwitchStmt(const ASTSwitchStmt* astSwitchStmt);
        ...
        */
        std::unique_ptr<node::IRCaseStmt> transformCaseStmt(const ASTCaseStmt* astCaseStmt);
        ...
        */
        std::unique_ptr<node::IRDefaultStmt> transformDefaultStmt(const ASTDefaultStmt* astDefaultStmt);
        ...
        */
        std::unique_ptr<node::IRSwitchBlockStmt> transformSwitchBlockStmt(const ASTSwitchBlockStmt* astSwitchBlockStmt);
